...
<section class="hero-classic">
  <div class="container">
    <h1 class="brand-title mb-0">Deportes</h1>
    <p class="byline">Resultados, historias y análisis</p>
  </div>
</section>
...
<main class="container py-5">
  <div class="row g-4">
    <div class="col-lg-8">
      <h2 class="section-title">Crónica</h2>
      <article class="mb-4 pb-4 border-bottom">
        <div class="kicker">Fútbol</div>
        ...
        <a class="link-primary" href="#">Leer crónica</a>
      </article>
      <article class="mb-4 pb-4 border-bottom">
        <div class="kicker">Polideportivo</div>
        <h3 class="h2">Récord nacional en pista cubierta</h3>
        <p class="byline">Atletismo — Hoy</p>
        <p>Marcas históricas en 400 metros; próxima cita, el torneo regional.</p>
      </article>
    </div>
    <div class="col-lg-4">
      <h2 class="section-title">Agenda</h2>
      <ul class="list-unstyled">
        <li class="mb-2"><i class="bi bi-calendar-event"></i> Clásico regional — Sábado</li>
        <li class="mb-2"><i class="bi bi-calendar-event"></i> Sudamericano sub-20 — Próxima semana</li>
        <li class="mb-2"><i class="bi bi-calendar-event"></i> Liga femenina — En curso</li>
      </ul>
    </div>
  </div>
</main>
