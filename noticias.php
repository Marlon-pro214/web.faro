...
<section class="hero-classic">
  <div class="container">
    <h1 class="brand-title mb-0">Noticias</h1>
    <p class="byline">Actualidad local, nacional e internacional</p>
  </div>
</section>
  ...
  <div class="row g-4">
    <div class="col-lg-8">
      ...
      <article class="mb-4 pb-4 border-bottom">
        <div class="kicker">Última hora</div>
        <h3 class="h2">Cobertura en desarrollo</h3>
        <p class="byline">Redacción — Hoy</p>
        <p>Minuto a minuto con fuentes oficiales y equipos en terreno.</p>
      </article>
      <article class="mb-4 pb-4 border-bottom">
        <div class="kicker">Reporte</div>
        <h3 class="h2">Panorama económico: inflación y empleo</h3>
        <p class="byline">Economía — Hoy</p>
        <p>Claves del IPC, salarios y actividad para el trimestre.</p>
      </article>
    </div>
    <div class="col-lg-4">
      <h2 class="section-title">Claves del día</h2>
      <ol class="list-group list-group-numbered">
        <li class="list-group-item">Seguridad: iniciativas en comisión.</li>
        <li class="list-group-item">Tipo de cambio y materias primas.</li>
        <li class="list-group-item">Agenda internacional de la semana.</li>
      </ol>
    </div>
  </div>
</main>
